...
<section id="hero" class="bg-team">
    <div class="overlay">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-1 pt-100 pb-100 fadeInLeft">
...
<section class="bg-light pt-90 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-1 fadeInLeft">
...
<section id="staumobil" class="bg-dark pt-100 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-2 fadeInLeft">
              <img class="img-responsive" src="http://placehold.it/375x667">
            </div>
